...
export default {async fetch(request,env,ctx){
  ...
  // Keep the real Dashboard tab, but strip the legacy dashboard markup before browser scripts run.
  html=html.replace(/(<section id="dashboard" class="tab active">)[\s\S]*?(<\/section>)/, '$1</section>');
