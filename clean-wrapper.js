...
/* Remove any leftover dark theme from sub-pages. */
...
/* Only Monetag is disabled. Adsterra is intentionally allowed. */
@media(max-width:650px){.nav{height:66px!important}.navin{padding:0 12px!important;gap:9px!important}.akhisave-menu{display:flex!important;flex:0 0 auto!important}.brand{gap:8px!important}.brand .brand-logo-only{width:42px!important;height:42px!important}.brand .brand-wordmark{width:98px!important;height:30px!important}.navlinks{display:none!important;position:absolute!important;left:10px!important;right:10px!important;top:70px!important;background:#fff!important;border:1px solid #dfe5ee!important;border-radius:14px!important;padding:7px!important;box-shadow:0 15px 35px #17203318!important;flex-direction:column!important;z-index:9999!important}.navlinks.open{display:flex!important}.navlinks a{font-size:12px!important;padding:11px!important}}
</style>`;
