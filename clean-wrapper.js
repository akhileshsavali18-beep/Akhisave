...
function theme(html,isAdmin){
 ...
 // Public/admin top bars use the single combined AkhiSave brand asset.
 out=out.replace(/(<a\s+class=["']brand["'][^>]*>)[\s\S]*?<\/a>/gi,`$1<img class="ak-combined-brand" src="${COMBINED}" alt="AkhiSave"></a>`);
...
.navin,.topin{max-width:1180px!important}.brand{display:flex!important;align-items:center!important;gap:0!important;text-decoration:none!important}.brand .ak-combined-brand{content:url('${COMBINED}')!important;width:170px!important;height:58px!important;object-fit:contain!important;border-radius:0!important;display:block!important}.brand strong{display:none!important}
