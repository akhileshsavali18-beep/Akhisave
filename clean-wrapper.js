...
function cleanHtml(html){
  ...
  if(isWebsite){
    ...
    out=out.replace(/<\/head>/i,`<style id="akhisave-final-ui">.brand{display:flex!important;align-items:center!important;gap:7px!important}.brand strong,.brand b{display:none!important}.brand-logo-mark{width:42px!important;height:42px!important;object-fit:contain!important;border-radius:0!important}.brand-logo-wordmark{width:108px!important;height:30px!important;object-fit:contain!important;border-radius:0!important}.ad,.akhisave-ad-slot,.akhisave-ad-banner,.akhisave-ad-placeholder,.ad-banner,.ad-slot,.social-bar,[id*="ad-"]{display:none!important}@media(max-width:600px){.brand-logo-mark{width:38px!important;height:38px!important}.brand-logo-wordmark{width:96px!important;height:27px!important}.brand{gap:6px!important}}</style></head>`);
